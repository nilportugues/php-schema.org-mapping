...
use NilPortugues\SchemaOrg\Properties\PartOfTVSeriesProperty;
 ...
 * Classes TVEpisode.
 */
class TVEpisode extends SchemaClass
{
    /**
     * @var string
     */
    protected static $schemaUrl = 'http://schema.org/TVEpisode';
     ...
     * @return Mapping
     */
    public static function partOfTVSeries()
    {
        return PartOfTVSeriesProperty::create(self::schemaUrl());
    }
