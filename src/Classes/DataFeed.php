...
use NilPortugues\SchemaOrg\Properties\DataFeedElementProperty;
 ...
 * Classes DataFeed.
 */
class DataFeed extends SchemaClass
{
    /**
     * @var string
     */
    protected static $schemaUrl = 'http://schema.org/DataFeed';
     ...
     * @return Mapping
     */
    public static function dataFeedElement()
    {
        return DataFeedElementProperty::create(self::schemaUrl());
    }
