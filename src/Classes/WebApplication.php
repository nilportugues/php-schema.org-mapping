...
use NilPortugues\SchemaOrg\Properties\BrowserRequirementsProperty;
...
class WebApplication extends SchemaClass
{
     ...
     * @return Mapping
     */
    public static function browserRequirements()
    {
        return BrowserRequirementsProperty::create(self::schemaUrl());
    }
