...
use NilPortugues\SchemaOrg\Properties\CaptionProperty;
...
use NilPortugues\SchemaOrg\Properties\VideoFrameSizeProperty;
use NilPortugues\SchemaOrg\Properties\VideoProperty;
use NilPortugues\SchemaOrg\Properties\VideoQualityProperty;
 ...
 * Classes VideoObject.
 */
class VideoObject extends SchemaClass
{
    /**
     * @var string
     */
    protected static $schemaUrl = 'http://schema.org/VideoObject';
    ...
    {
        return CaptionProperty::create(self::schemaUrl());
    }
    ...
    {
        return ThumbnailProperty::create(self::schemaUrl());
    }
    ...
    {
        return TranscriptProperty::create(self::schemaUrl());
    }
     ...
     * @return Mapping
     */
    public static function videoFrameSize()
    {
        return VideoFrameSizeProperty::create(self::schemaUrl());
    }

    /**
     * @return Mapping
     */
    public static function videoQuality()
    {
        return VideoQualityProperty::create(self::schemaUrl());
    }
