...
use NilPortugues\SchemaOrg\Properties\Caption;
...
use NilPortugues\SchemaOrg\Properties\VideoFrameSize;
use NilPortugues\SchemaOrg\Properties\VideoQuality;
...
class VideoObject
{
    ...
    {
        return Transcript::create(self::schemaUrl());
    }
    ...
    {
        return VideoFrameSize::create(self::schemaUrl());
    }
    ...
    {
        return VideoQuality::create(self::schemaUrl());
    }
