...
use NilPortugues\SchemaOrg\Properties\OrderItemNumberProperty;
use NilPortugues\SchemaOrg\Properties\OrderItemStatusProperty;
use NilPortugues\SchemaOrg\Properties\OrderQuantityProperty;
...
class OrderItem
{
    ...
    {
        return OrderItemNumberProperty::create(self::schemaUrl());
    }
    ...
    {
        return OrderItemStatusProperty::create(self::schemaUrl());
    }
    ...
    {
        return OrderQuantityProperty::create(self::schemaUrl());
    }
