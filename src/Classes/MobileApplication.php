...
use NilPortugues\SchemaOrg\Properties\CarrierRequirementsProperty;
...
/**
 * Classes MobileApplication.
 */
class MobileApplication extends SchemaClass
{
    /**
     * @var string
     */
    protected static $schemaUrl = 'http://schema.org/MobileApplication';
     ...
     * @return Mapping
     */
    public static function carrierRequirements()
    {
        return CarrierRequirementsProperty::create(self::schemaUrl());
    }
