...
use NilPortugues\SchemaOrg\Properties\RecommendationStrength;
...
class MedicalGuidelineRecommendation
{
     ...
     * @var string
     */
    private static $schemaUrl = 'http://schema.org/MedicalGuidelineRecommendation';
    ...
    {
        return RecommendationStrength::create(self::schemaUrl());
    }
