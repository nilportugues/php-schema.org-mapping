...
use NilPortugues\SchemaOrg\Properties\AlbumProperty;
use NilPortugues\SchemaOrg\Properties\AlbumsProperty;
...
use NilPortugues\SchemaOrg\Properties\MusicGroupMemberProperty;
...
class MusicGroup
{
    ...
    {
        return AlbumProperty::create(self::schemaUrl());
    }
    ...
    {
        return AlbumsProperty::create(self::schemaUrl());
    }
     ...
     * @return Mapping
     */
    public static function musicGroupMember()
    {
        return MusicGroupMemberProperty::create(self::schemaUrl());
    }
    ...
    {
        return TracksProperty::create(self::schemaUrl());
    }
