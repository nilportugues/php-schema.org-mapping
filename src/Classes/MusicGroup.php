...
use NilPortugues\SchemaOrg\Properties\Album;
use NilPortugues\SchemaOrg\Properties\Albums;
...
use NilPortugues\SchemaOrg\Properties\MusicGroupMember;
...
use NilPortugues\SchemaOrg\Properties\Tracks;
...
class MusicGroup
{
    ...
    */
    ...
    {
        return Album::create(self::schemaUrl());
    }
    ...
    */
    ...
    {
        return Albums::create(self::schemaUrl());
    }
    ...
    */
    ...
    {
        return MusicGroupMember::create(self::schemaUrl());
    }
    ...
    */
    ...
    {
        return Tracks::create(self::schemaUrl());
    }
