...
use NilPortugues\SchemaOrg\Properties\HospitalAffiliationProperty;
...
class Physician extends SchemaClass
{
     ...
     * @return Mapping
     */
    public static function hospitalAffiliation()
    {
        return HospitalAffiliationProperty::create(self::schemaUrl());
    }
