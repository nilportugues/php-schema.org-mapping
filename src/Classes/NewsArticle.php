...
use NilPortugues\SchemaOrg\Properties\DatelineProperty;
...
use NilPortugues\SchemaOrg\Properties\PrintColumnProperty;
use NilPortugues\SchemaOrg\Properties\PrintEditionProperty;
use NilPortugues\SchemaOrg\Properties\PrintPageProperty;
use NilPortugues\SchemaOrg\Properties\PrintSectionProperty;
 ...
 * Classes NewsArticle.
 */
class NewsArticle extends SchemaClass
{
    /**
     * @var string
     */
    protected static $schemaUrl = 'http://schema.org/NewsArticle';
     ...
     * @return Mapping
     */
    public static function dateline()
    {
        return DatelineProperty::create(self::schemaUrl());
    }
     ...
     * @return Mapping
     */
    public static function printColumn()
    {
        return PrintColumnProperty::create(self::schemaUrl());
    }

    /**
     * @return Mapping
     */
    public static function printEdition()
    {
        return PrintEditionProperty::create(self::schemaUrl());
    }
    ...
    {
        return PrintPageProperty::create(self::schemaUrl());
    }
    ...
    {
        return PrintSectionProperty::create(self::schemaUrl());
    }
