...
use NilPortugues\SchemaOrg\Properties\Dateline;
...
use NilPortugues\SchemaOrg\Properties\PrintColumn;
use NilPortugues\SchemaOrg\Properties\PrintEdition;
use NilPortugues\SchemaOrg\Properties\PrintPage;
use NilPortugues\SchemaOrg\Properties\PrintSection;
...
class NewsArticle
{
    ...
    */
    ...
    {
        return Dateline::create(self::schemaUrl());
    }
    ...
    */
    ...
    {
        return PrintColumn::create(self::schemaUrl());
    }
    ...
    */
    ...
    {
        return PrintEdition::create(self::schemaUrl());
    }
    ...
    */
    ...
    {
        return PrintPage::create(self::schemaUrl());
    }
    ...
    */
    ...
    {
        return PrintSection::create(self::schemaUrl());
    }
