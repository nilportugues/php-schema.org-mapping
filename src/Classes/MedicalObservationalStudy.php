...
use NilPortugues\SchemaOrg\Properties\StudyDesignProperty;
use NilPortugues\SchemaOrg\Properties\StudyProperty;
use NilPortugues\SchemaOrg\SchemaClass;

/**
 * Classes MedicalObservationalStudy.
 */
class MedicalObservationalStudy extends SchemaClass
{
     ...
     * @return Mapping
     */
    public static function studyDesign()
    {
        return StudyDesignProperty::create(self::schemaUrl());
    }
}
