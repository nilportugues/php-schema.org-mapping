...
use NilPortugues\SchemaOrg\Properties\CodeValue;
use NilPortugues\SchemaOrg\Properties\CodingSystem;
...
class MedicalCode
{
    ...
    {
        return CodeValue::create(self::schemaUrl());
    }
    ...
    {
        return CodingSystem::create(self::schemaUrl());
    }
