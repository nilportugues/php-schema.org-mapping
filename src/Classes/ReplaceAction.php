...
use NilPortugues\SchemaOrg\Properties\ReplaceeProperty;
use NilPortugues\SchemaOrg\Properties\ReplacerProperty;
...
class ReplaceAction extends SchemaClass
{
    ...
    {
        return ReplaceeProperty::create(self::schemaUrl());
    }
    ...
    {
        return ReplacerProperty::create(self::schemaUrl());
    }
