 ...
 */
class LocalBusiness extends SchemaClass
{
    /**
     * @var string
     */
    protected static $schemaUrl = 'http://schema.org/LocalBusiness';
    ...
    {
        return BranchOfProperty::create(self::schemaUrl());
    }
    ...
    {
        return CurrenciesAcceptedProperty::create(self::schemaUrl());
    }
    ...
    {
        return OpeningHoursProperty::create(self::schemaUrl());
    }
    ...
    {
        return PaymentAcceptedProperty::create(self::schemaUrl());
    }
    ...
    {
        return PriceRangeProperty::create(self::schemaUrl());
    }
