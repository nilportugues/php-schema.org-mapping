...
use NilPortugues\SchemaOrg\Properties\AcceptsReservations;
...
use NilPortugues\SchemaOrg\Properties\Menu;
...
use NilPortugues\SchemaOrg\Properties\ServesCuisine;
...
class FoodEstablishment
{
    ...
    {
        return AcceptsReservations::create(self::schemaUrl());
    }
    ...
    {
        return Menu::create(self::schemaUrl());
    }
    ...
    {
        return ServesCuisine::create(self::schemaUrl());
    }
