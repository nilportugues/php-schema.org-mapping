...
use NilPortugues\SchemaOrg\Properties\ExifDataProperty;
...
use NilPortugues\SchemaOrg\Properties\RepresentativeOfPageProperty;
...
class ImageObject extends SchemaClass
{
    ...
    {
        return ExifDataProperty::create(self::schemaUrl());
    }
    ...
    {
        return RepresentativeOfPageProperty::create(self::schemaUrl());
    }
