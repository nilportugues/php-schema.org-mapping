...
/**
 * Classes HomeAndConstructionBusiness.
 */
class HomeAndConstructionBusiness extends SchemaClass
{
    /**
     * @var string
     */
    protected static $schemaUrl = 'http://schema.org/HomeAndConstructionBusiness';
