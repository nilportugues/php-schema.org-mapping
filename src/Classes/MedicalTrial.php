...
use NilPortugues\SchemaOrg\Properties\Phase;
...
use NilPortugues\SchemaOrg\Properties\TrialDesign;
...
class MedicalTrial
{
    ...
    {
        return Phase::create(self::schemaUrl());
    }
    ...
    {
        return TrialDesign::create(self::schemaUrl());
    }
}
