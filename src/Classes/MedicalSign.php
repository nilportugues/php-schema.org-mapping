...
use NilPortugues\SchemaOrg\Properties\IdentifyingExam;
use NilPortugues\SchemaOrg\Properties\IdentifyingTest;
...
class MedicalSign
{
    ...
    {
        return IdentifyingExam::create(self::schemaUrl());
    }
    ...
    {
        return IdentifyingTest::create(self::schemaUrl());
    }
