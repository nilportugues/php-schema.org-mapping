...
use NilPortugues\SchemaOrg\Properties\Dependencies;
...
use NilPortugues\SchemaOrg\Properties\ProficiencyLevel;
...
class TechArticle
{
    ...
    */
    ...
    {
        return Dependencies::create(self::schemaUrl());
    }
    ...
    */
    ...
    {
        return ProficiencyLevel::create(self::schemaUrl());
    }
