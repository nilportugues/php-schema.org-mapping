...
use NilPortugues\SchemaOrg\Properties\DependenciesProperty;
...
use NilPortugues\SchemaOrg\Properties\ProficiencyLevelProperty;
...
class TechArticle extends SchemaClass
{
    ...
    {
        return DependenciesProperty::create(self::schemaUrl());
    }
     ...
     * @return Mapping
     */
    public static function proficiencyLevel()
    {
        return ProficiencyLevelProperty::create(self::schemaUrl());
    }
