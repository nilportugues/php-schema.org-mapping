...
class ReviewAction extends SchemaClass
{
     ...
     * @return Mapping
     */
    public static function resultReview()
    {
        return ResultReviewProperty::create(self::schemaUrl());
    }
