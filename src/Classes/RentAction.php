...
use NilPortugues\SchemaOrg\Properties\LandlordProperty;
...
use NilPortugues\SchemaOrg\Properties\RealEstateAgentProperty;
...
class RentAction
{
     ...
     * @var string
     */
    private static $schemaUrl = 'http://schema.org/RentAction';
    ...
    {
        return LandlordProperty::create(self::schemaUrl());
    }
    ...
    {
        return RealEstateAgentProperty::create(self::schemaUrl());
    }
