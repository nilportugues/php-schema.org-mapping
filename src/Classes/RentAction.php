...
use NilPortugues\SchemaOrg\Properties\Landlord;
...
use NilPortugues\SchemaOrg\Properties\RealEstateAgent;
...
class RentAction
{
    ...
    {
        return Landlord::create(self::schemaUrl());
    }
    ...
    {
        return RealEstateAgent::create(self::schemaUrl());
    }
