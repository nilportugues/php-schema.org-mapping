 ...
 * Classes Role.
 */
class Role extends SchemaClass
{
    /**
     * @var string
     */
    protected static $schemaUrl = 'http://schema.org/Role';
    ...
    {
        return NamedPositionProperty::create(self::schemaUrl());
    }
    ...
    {
        return RoleNameProperty::create(self::schemaUrl());
    }
