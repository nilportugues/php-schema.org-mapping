 ...
 * METHODSTART.
 *
 * @method static \NilPortugues\SchemaOrg\Properties\ImagingTechniqueProperty imagingTechnique()
 ...
 */
class ImagingTest extends SchemaClass
{
    /**
     * @var string
     */
    protected static $schemaUrl = 'http://schema.org/ImagingTest';
    ...
    protected static $supportedMethods = [
        ...
        'imagingTechnique' => [
            'propertyClass' => '\NilPortugues\SchemaOrg\Properties\ImagingTechniqueProperty',
            'schemaClass' => '\NilPortugues\SchemaOrg\Classes\ImagingTest',
        ],
        'medicineSystem' => [
