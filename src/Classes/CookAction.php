...
use NilPortugues\SchemaOrg\Properties\FoodEstablishment;
use NilPortugues\SchemaOrg\Properties\FoodEvent;
...
use NilPortugues\SchemaOrg\Properties\Recipe;
...
class CookAction
{
     ...
     * @var string
     */
    private static $schemaUrl = 'http://schema.org/CookAction';
    ...
    {
        return FoodEstablishment::create(self::schemaUrl());
    }
    ...
    {
        return FoodEvent::create(self::schemaUrl());
    }
    ...
    {
        return Recipe::create(self::schemaUrl());
    }
