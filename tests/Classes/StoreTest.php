...
class StoreTest extends \PHPUnit_Framework_TestCase
{
    ...
    {
        $this->assertInstanceOf(Mapping::class, Store::additionalType());
    }
    ...
    {
        $this->assertInstanceOf(Mapping::class, Store::alternateName());
    }
    ...
    {
        $this->assertInstanceOf(Mapping::class, Store::branchOf());
    }
    ...
    {
        $this->assertInstanceOf(Mapping::class, Store::currenciesAccepted());
    }
    ...
    {
        $this->assertInstanceOf(Mapping::class, Store::description());
    }
    ...
    {
        $this->assertInstanceOf(Mapping::class, Store::image());
    }
    ...
    {
        $this->assertInstanceOf(Mapping::class, Store::mainEntityOfPage());
    }
    ...
    {
        $this->assertInstanceOf(Mapping::class, Store::name());
    }
    ...
    {
        $this->assertInstanceOf(Mapping::class, Store::openingHours());
    }
    ...
    {
        $this->assertInstanceOf(Mapping::class, Store::paymentAccepted());
    }
    ...
    {
        $this->assertInstanceOf(Mapping::class, Store::potentialAction());
    }

    public function testPriceRangeWillReturnMappingObject()
    {
        $this->assertInstanceOf(Mapping::class, Store::priceRange());
    }
    ...
    {
        $this->assertInstanceOf(Mapping::class, Store::sameAs());
    }
    ...
    {
        $this->assertInstanceOf(Mapping::class, Store::url());
    }
