...
class RadioStationTest extends \PHPUnit_Framework_TestCase
{
    ...
    {
        $this->assertInstanceOf(Mapping::class, RadioStation::additionalType());
    }
    ...
    {
        $this->assertInstanceOf(Mapping::class, RadioStation::alternateName());
    }
    ...
    {
        $this->assertInstanceOf(Mapping::class, RadioStation::branchOf());
    }
    ...
    {
        $this->assertInstanceOf(Mapping::class, RadioStation::currenciesAccepted());
    }
    ...
    {
        $this->assertInstanceOf(Mapping::class, RadioStation::description());
    }
    ...
    {
        $this->assertInstanceOf(Mapping::class, RadioStation::image());
    }
    ...
    {
        $this->assertInstanceOf(Mapping::class, RadioStation::mainEntityOfPage());
    }
    ...
    {
        $this->assertInstanceOf(Mapping::class, RadioStation::name());
    }
    ...
    {
        $this->assertInstanceOf(Mapping::class, RadioStation::openingHours());
    }
    ...
    {
        $this->assertInstanceOf(Mapping::class, RadioStation::paymentAccepted());
    }
    ...
    {
        $this->assertInstanceOf(Mapping::class, RadioStation::potentialAction());
    }

    public function testPriceRangeWillReturnMappingObject()
    {
        $this->assertInstanceOf(Mapping::class, RadioStation::priceRange());
    }
    ...
    {
        $this->assertInstanceOf(Mapping::class, RadioStation::sameAs());
    }
    ...
    {
        $this->assertInstanceOf(Mapping::class, RadioStation::url());
    }
